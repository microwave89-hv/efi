...
--*/
{
    ...
    DebugAssert(Drive->QueryOptimalTransferLength() <= MAXULONG);
    _data_aligned = ((data_offset.GetLowPart() % Drive->QueryOptimalTransferLength()) == 0);
                ...
                *FatSize = RoundUpDiv((clusters+2) * fat_entry_size , SectorSize);
                ...
                if (_drive->IsFloppy() ||
                    ((((BIG_INT)data_sector_offset*SectorSize).GetLowPart() %
                      _drive->QueryOptimalTransferLength()) == 0)) {
...
--*/
{
    ...
    DebugAssert (_drive->IsFloppy() ||
                 ((data_offset.GetLowPart() % _drive->QueryOptimalTransferLength()) == 0));
#endif
...
--*/
{
    ...
    if ( _ft == LARGE32 ) {
        ...
        _bootcodesize = FAT32BOOTCODE_SIZE;
    }
    else {
...
--*/
{
...

   {
      ...
      Foo = _sector_zero.Bpb.ReservedSectors;
