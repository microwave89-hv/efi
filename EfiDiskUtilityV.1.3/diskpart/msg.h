...
//
#define MSG_ABOUT       L"          - Show version information\n"
#define MSG_ABOUT_FMT   L"%s Version %d.%d. Based on UEFI Version %s\n"
...
#define MSG_INSPECT05   L"Inspect for MBR disks not implemented\n"
...
#define MSG_NEW04       L"New of MBR disks not supported\n"
