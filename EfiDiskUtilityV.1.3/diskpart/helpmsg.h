...
CHAR16  *CreateHelpText[] = {
        ...
        L"attr=aaa is optional. aaa is a 64-bit HEX string of attribute flags.\n",
        L"     Attributes Bits[0..31] EFI Reserved.\n"
        L"                Bits[32..63] Paritition-type specific\n",
        L"           Bit 0 Required for the platform to function properly\n",
        L"ver optional command to turn on verbose status.\n",
        L"examples:\n",
        L"  create name=\"a partition\" type=MSDATA size=0 attr=1\n",
