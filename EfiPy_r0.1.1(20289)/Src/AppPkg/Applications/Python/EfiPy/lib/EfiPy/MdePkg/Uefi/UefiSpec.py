...
EFI_MEMORY_UC   = 0x0000000000000001L
EFI_MEMORY_WC   = 0x0000000000000002L
EFI_MEMORY_WT   = 0x0000000000000004L
EFI_MEMORY_WB   = 0x0000000000000008L
EFI_MEMORY_UCE  = 0x0000000000000010L

EFI_MEMORY_WP               = 0x0000000000001000L
EFI_MEMORY_RP               = 0x0000000000002000L
EFI_MEMORY_XP               = 0x0000000000004000L
EFI_MEMORY_RO               = 0x0000000000020000L

EFI_MEMORY_NV               = 0x0000000000008000L
EFI_MEMORY_MORE_RELIABLE    = 0x0000000000010000L
...
EVT_TIMER                         = 0x80000000L
EVT_RUNTIME                       = 0x40000000L
EVT_NOTIFY_WAIT                   = 0x00000100L
EVT_NOTIFY_SIGNAL                 = 0x00000200L

EVT_SIGNAL_EXIT_BOOT_SERVICES     = 0x00000201L
EVT_SIGNAL_VIRTUAL_ADDRESS_CHANGE = 0x60000202L

EVT_RUNTIME_CONTEXT               = 0x20000000L
...
EFI_OPEN_PROTOCOL_BY_HANDLE_PROTOCOL  = 0x00000001L
EFI_OPEN_PROTOCOL_GET_PROTOCOL        = 0x00000002L
EFI_OPEN_PROTOCOL_TEST_PROTOCOL       = 0x00000004L
EFI_OPEN_PROTOCOL_BY_CHILD_CONTROLLER = 0x00000008L
EFI_OPEN_PROTOCOL_BY_DRIVER           = 0x00000010L
EFI_OPEN_PROTOCOL_EXCLUSIVE           = 0x00000020L
...
CAPSULE_FLAGS_PERSIST_ACROSS_RESET          = 0x00010000L
CAPSULE_FLAGS_POPULATE_SYSTEM_TABLE         = 0x00020000L
CAPSULE_FLAGS_INITIATE_RESET                = 0x00040000L
...
EFI_OS_INDICATIONS_BOOT_TO_FW_UI                    = 0x0000000000000001L
EFI_OS_INDICATIONS_TIMESTAMP_REVOCATION             = 0x0000000000000002L
EFI_OS_INDICATIONS_FILE_CAPSULE_DELIVERY_SUPPORTED  = 0x0000000000000004L
EFI_OS_INDICATIONS_FMP_CAPSULE_SUPPORTED            = 0x0000000000000008L
EFI_OS_INDICATIONS_CAPSULE_RESULT_VAR_SUPPORTED     = 0x0000000000000010L
...
if EFIPY_MDE_CPU_TYPE == EFIPY_MDE_CPU_IA32:
  EFI_REMOVABLE_MEDIA_FILE_NAME   = EFI_REMOVABLE_MEDIA_FILE_NAME_IA32
...
elif EFIPY_MDE_CPU_TYPE == EFIPY_MDE_CPU_ARM or EFIPY_MDE_CPU_TYPE == EFIPY_MDE_CPU_EBC:
  EFI_REMOVABLE_MEDIA_FILE_NAME   = EFI_REMOVABLE_MEDIA_FILE_NAME_ARM
elif EFIPY_MDE_CPU_TYPE == EFIPY_MDE_CPU_AARCH64:
  EFI_REMOVABLE_MEDIA_FILE_NAME   = EFI_REMOVABLE_MEDIA_FILE_NAME_AARCH64
